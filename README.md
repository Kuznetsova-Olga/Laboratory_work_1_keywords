...
2.Navigate to the laboratory work #1:  
`cd lab_1_keywords_tfidf`  
2.Replace the files in the corresponding laboratory work with the files from this repository.      
3.Run the program to verify that it works correctly.
